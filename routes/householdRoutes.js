...
// Create household
router.post('/createhousehold', householdValidator, validUserEmail, validHeadOfHousehold, houseController.createHousehold);

// Update household by id
router.put('/updatehousehold/:id', householdValidator, validUserEmail, validHeadOfHousehold, houseController.updateHousehold);
