...
describe('Format News', () => {
  ...
  test('It should format news correctly', async () => {
    const news = {
      ...
      newsTitle: 'Test News',
      newsBody: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam.',
      status: 'public',
      picture: 'test.jpg',
    };
    ...
    expect(formattedNews.newsBody).toBe('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed curs...'); // Check for shortened body
